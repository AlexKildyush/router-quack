...
public class ValidLoopbackSpacesTests
{
    ...
    public async Task Validate_ValidIpv4LoopbackSpace_NoErrors(string address)
    {
        ...
        {
            TestData.CreateAs(networksIpVersion: IpVersion.Ipv4,
    ...
    public async Task Process_MissingLoopbackSpaceV4_SetsErrorsOccurred()
    {
        ...
        var asses = new List<As>
        {
            TestData.CreateAs(loopbackSpaceV4: null, networksIpVersion: IpVersion.Ipv4, routers: [router])
        };
    ...
    public async Task Process_MissingLoopbackSpaceV6_SetsErrorsOccurred()
    {
        ...
        var asses = new List<As>
        {
            TestData.CreateAs(loopbackSpaceV6: null, networksIpVersion: IpVersion.Ipv6, routers: [router])
        };
    ...
    public async Task Process_NoLoopbackSpaceV4_SetsErrorsOccurred()
    {
        ...
        var asses = new List<As>
        {
            TestData.CreateAs(loopbackSpaceV4: null, networksIpVersion: IpVersion.Ipv4, routers: routers)
        };
    ...
    public async Task Process_NoLoopbackSpaceV6_SetsErrorsOccurred()
    {
        ...
        var asses = new List<As>
        {
            TestData.CreateAs(loopbackSpaceV6: null, networksIpVersion: IpVersion.Ipv6, routers: routers)
        };
